...
public class Parser {
    ...
    private int checkForObject(String token, List<ObjectGame> obejcts) {
    ...
    public ParserOutput parse(String command, List<Command> commands, List<ObjectGame> objects, List<ObjectGame> inventory) {
